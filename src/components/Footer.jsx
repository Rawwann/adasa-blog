                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="flex items-center gap-3">
                            {[FaYoutube, FaLinkedinIn, FaGithub, FaXTwitter].map((Icon, i) => (
                                <a
                                    key={i}
                                    href="#"
                    ...
                    <div>
                        ...
                        <ul className="space-y-4">
                            {['الرئيسية', 'المدونة', 'من نحن'].map((item, i) => (
                                <li key={i}>
                                    <Link to={item === 'الرئيسية' ? '/' : `/${item === 'المدونة' ? 'blog' : 'about'}`} className="group flex items-center gap-2 text-neutral-400 hover:text-primary transition-all duration-300 text-sm">
                    ...
                    <div>
                        ...
                        <ul className="space-y-4">
                            {['إضاءة', 'بورتريه', 'مناظر طبيعية', 'تقنيات'].map((item, i) => (
                                <li key={i}>
                                    <Link to={`/blog?category=${item}`} className="group flex items-center gap-2 text-neutral-400 hover:text-primary transition-all duration-300 text-sm">
                                        <FiChevronLeft className="w-4 h-4 text-primary opacity-0 -translate-x-2 group-hover:opacity-100 group-hover:translate-x-0 transition-all duration-300" />
                                        <span className="transition-transform duration-300 group-hover:-translate-x-1">{item}</span>
                                    </Link>
                                </li>
                    ...
                    <div>
                        ...
                        <form className="space-y-4" onSubmit={(e) => e.preventDefault()}>
                            ...
                            />
                            <Button
                                className="w-full bg-primary hover:bg-primary-600 text-white font-bold rounded-xl h-14 text-sm transition-all duration-300 hover:-translate-y-1"                            >
                                اشترك
                            </Button>
                        </form>
                    </div>
